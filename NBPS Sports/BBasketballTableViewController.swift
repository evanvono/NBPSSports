...
//  BBasketballTableViewController.swift
//  NBPS Sports
//
...
class BBasketballTableViewController: UITableViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        SwiftSpinner.show("Loading Basketball Games...")
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(BBasketballTableViewController.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(BBasketballTableViewController.keyboardWillHide(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
    ...
    deinit {
        ...
        self.ref.child("Sports").child("BBasketball").removeAllObservers()
    }
    ...
    @IBAction func didChangeSwitch(_ sender: Any) {
        ...
        ref = FIRDatabase.database().reference()
        let gameDirec = ref.child("Sports").child("BBasketball").child(currentGame)
    ...
    /*
     ...
     self.ref.child("Sports").child("BBasketball").observe(FIRDataEventType.value, with: { (snapshot) in
     
     let count = snapshot.childrenCount
     print("database count: \(count)")
     
     _refHandle = self.ref.child("Sports").child("BBasketball").observe(FIRDataEventType.childAdded, with: { (snapshot) in
    ...
    /*
     ...
     self.ref.child("Sports").child("BBasketball").observeSingleEvent(of: .value, with: { (snapshot) in
     ...
     */
     ...
     self._refHandle = self.ref.child("Sports").child("BBasketball").observe(FIRDataEventType.childAdded, with: { (snapshot) in
    ...
    func getNewData(){
        ...
        ref.child("Sports").child("BBasketball").observeSingleEvent(of: .value, with: { (snapshot) in
    ...
    func getChangedData(){
        ...
        _refHandle = self.ref.child("Sports").child("BBasketball").observe(FIRDataEventType.childChanged, with: { (snapshot) in
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        /*  ref.child("BBasketball").child(games[indexPath.section][indexPath.row]["Snapshot"]).observe(.value, with: { (snapshot) in
    ...
    @IBAction func changeTapped(_ sender: Any) {
        ...
        self.ref.child("Sports").child("BBasketball").child(currentGame).setValue(updatedData) { (error, ref) in
            
            if error == nil{
                
                print("completed change, trying to edit app data...")
                
                self._refHandle = self.ref.child("Sports").child("BBasketball").child(self.currentGame).observe(FIRDataEventType.value, with: { (snapshot) in
        ...
        /*
         ...
         _refHandle = self.ref.child("Sports").child("BBasketball").child(currentGame).observe(FIRDataEventType.value, with: { (snapshot) in
         ...
         let gameDirec = self.ref.child("Sports").child("BBasketball").child(self.currentGame)
